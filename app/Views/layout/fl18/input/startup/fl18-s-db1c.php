<div class="table-responsive" id="fl18-s-db1c">
<?= csrf_field(); ?>
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
    ...
    <thead align="center">
        <tr>
        <th colspan="19" scope="col"><?php echo nl2br("LD DIE BONDING 1 MACHINE Model GH17P28F8CL")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
    ...
    <tbody>
        ...
        <tr>
          ...
          <td >0.30 ~ 0.50 MPa</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par002',0.30,0.50)"  id="par002" name="par002" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par002'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >0.20 ~ 0.30 N</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par006',0.20,0.30)"  id="par006" name="par006" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par006'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          <td >12</td>
          <td >* Pengecekan kondisi collet guide</td>
          <td >Cek apakah collet guide goyang</td>
          <td>
        ...
        <tr>
          ...
          <td >180 ~ 220 °C</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par015',180,220)" id="par015" name="par015" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par015'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par016',295,335)" id="par016" name="par016" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par016'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          <td>Step 2 : 0°C</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par017',-1,1)" id="par017" name="par017" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par017'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par018',0.40,0.60)" id="par018" name="par018" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par018'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          <td>Step 2 : 0 s (UP)</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par019',-1,1)" id="par019" name="par019" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par019'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par020',1,3)" id="par020" name="par020" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par020'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          <td >Step 2 : 0 s (HT)</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par021',-1,1)" id="par021" name="par021" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par021'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par022',190,230)" id="par022" name="par022" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par022'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par023',295,335)" id="par023" name="par023" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par023'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td > 2.5 s</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par024',2,3)" id="par024" name="par024" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par024'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td rowspan="2">50</td>
          <td rowspan="2">
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par025',40,60)" id="par025" name="par025" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par025'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td > 300</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par026',290,310)" id="par026" name="par026" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par026'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td > 300</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par027',290,310)" id="par027" name="par027" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par027'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >10</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par028',0,20)" id="par028" name="par028" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par028'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >1000</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par029',990,1010)" id="par029" name="par029" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par029'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >0</td>
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par030',-1,1)" id="par030" name="par030" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par030'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td >
            <input class="form-control" type="number" step="0.00000001" onchange="changeRange('par031',5,6)" id="par031" name="par031" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par031'];} ?>>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <select class="form-select" id="par034" name="par034">
                <?php if(isset($alldata)){
                    if($alldata[0]["par034"]=="-"){
                        echo '
                        <option value="-" selected>-</option>
