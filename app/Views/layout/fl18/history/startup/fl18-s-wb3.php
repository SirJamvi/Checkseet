<div class="table-responsive mt-3" id="fl18-s-wb3">
<?= csrf_field(); ?>
...
<table class="table table-bordered table-hover" id="table1">
    <thead align="center">
        <tr>
            <th colspan=<?= 5+$lenData ?> scope="col"><?php echo nl2br("WIRE BOND MACHINE START UP")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <?php for($i = 0; $i < $lenData; $i=$i+3) { ?>
                <td colspan="3"><?= (string)$alldata[$i]['par021']; ?></td>
            <?php } ?>
        </tr>
