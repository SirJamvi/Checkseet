<div class="table-responsive mt-3" id="fl18-s-db1c">
<?= csrf_field(); ?>
...
<table class="table table-bordered table-hover" id="table1">
    <thead align="center">
        <tr>
        <th colspan=<?= 3+$lenData ?> scope="col"><?php echo nl2br("LD DIE BONDING 1 MACHINE Model GH17P28F8CL")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
            ...
            <th scope="col" colspan=<?= $lenData ?>>Hasil Start Up</th>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td rowspan="2">50</td>
            <?php for($i = 0; $i < $lenData; $i=$i+1) { ?>
                <td colspan="col" rowspan=2><?= (string)$alldata[$i]['par025']; ?></td>
            <?php } ?>
        </tr>
