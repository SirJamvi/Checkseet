<div class="table-responsive" id="sl90-p-ht">
<?= csrf_field(); ?>
          ...
          <table class="table table-striped-columns" 
            ...
            <thead align="center">
              ...
              <tr>
                ...
                <th class="input-form"  >TSP_1.Err (09)</th>
                <th class="input-form"  >If LD (11)</th>
                <th class="input-form"  >LD.Ir (12)</th>
                <th class="input-form"  >Vop2(14)</th>
                <th class="input-form"  >Lop2 (15)</th>
              </tr>

            <tr>              
                <th class="input-form" scope="col">Ith (16)</th>
                <th class="input-form" scope="col">Eta2 (17)</th>
                <th class="input-form" scope="col">L.Kink2 (28)</th>
                <th class="input-form" scope="col">Pmax (19)</th>
                <th class="input-form" scope="col">Imax (20)</th>
