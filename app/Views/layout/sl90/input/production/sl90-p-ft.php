<div class="table-responsive" id="sl90-p-ft">
<?= csrf_field(); ?>
...
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
      <table class="table table-striped-columns" 
        ...
        <thead align="center">
          <tr>
            <th colspan="19" scope="col"><?php echo nl2br("FINAL TEST 9.0")?></th>
          </tr>
        </thead>
        <thead align="center">
          <tr>
            <th class="input-form" colspan="4" scope="col" style="width:50%;">Quantity</th>
