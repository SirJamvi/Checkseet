<div class="table-responsive" id="sl90-s-ft">
<?= csrf_field(); ?>
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
    ...
    <thead align="center">
        <tr>
        <th colspan="19" scope="col"><?php echo nl2br("FINAL TEST MACHINE START UP (LD1360AHP Type)")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
    ...
    <tbody>
        ...
        <tr>
          <td >6</td>
          <td >* Cek temperature (terlihat pada digital thermometer)</td>
