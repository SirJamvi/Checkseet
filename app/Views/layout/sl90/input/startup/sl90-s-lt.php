<div class="table-responsive" id="sl90-s-lt">
<?= csrf_field(); ?>
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
    ...
    <tbody>
        <tr>
          ...
          <td >
            <input class="form-control" type="number" step=0.0001 id="par001" name="par001" onchange="changeRange('par001',0.44,0.54)" placeholder="" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par001'];} ?>>
          </td>
        </tr>
