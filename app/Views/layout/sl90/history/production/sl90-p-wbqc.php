...
<input type="hidden" id="cnt-table" value="1">
          <table class="table table-bordered table-hover"  id="table1"
            ...
            <thead align="center">
              <tr>
                <th colspan="35" scope="col"><?php echo nl2br("INSPECTION LDSM CONTROL")?></th>
              </tr>
            </thead>
            <thead align="center">
              <tr>
                ...
                <th rowspan="3" >Machine WB</th>
                <th colspan="4" >Quantity</th>
                <th colspan="15" >Reject Item</th>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td rowspan="1" ><?= $alldata[$i]['par033']; ?></td>
                  <td rowspan="1" ><?= $alldata[$i]['par034']; ?></td>
                  <td rowspan="1" ><?= $alldata[$i]['par004']; ?></td>
                  <td rowspan="1" ><?= $alldata[$i]['par005']; ?></td>
                  <td rowspan="2" > Total Others : <?= $alldata[$i]['par003']; ?></td>
                </tr>
                <tr>
                  ...
                  <td rowspan="1" ><?= $alldata[$i+1]['par031']; ?></td>
                  <td rowspan="1" ><?= $alldata[$i+1]['par032']; ?></td>
                  <td rowspan="1" ><?= $alldata[$i+1]['par033']; ?></td>
                  <td rowspan="1" ><?= $alldata[$i+1]['par034']; ?></td>
                  <td rowspan="1" ><?= $alldata[$i+1]['par004']; ?></td>
                  <td rowspan="1" ><?= $alldata[$i+1]['par005']; ?></td>
                </tr>
                <?php } ?>
            </tbody>
          </table>
