<div class="table-responsive mt-3" id="sl90-p-ft">
<?= csrf_field(); ?>
        ...
        <tbody>
            <?php for($i = 0; $i < count($alldata); $i=$i+4) { ?>
                <tr>
                    ...
                    <td rowspan="4" ><?= $alldata[$i]['par015']; ?></td>
                ...
                <tr>
                    ...
                    <td rowspan="1" ><?= $alldata[$i+1]['par030']; ?></td>
                </tr>
                <tr>
                    ...
                    <td rowspan="1" ><?= $alldata[$i+2]['par023']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+2]['par024']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+2]['par025']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+2]['par026']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+2]['par027']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+2]['par028']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+2]['par029']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+2]['par030']; ?></td>
                </tr>
                <tr>
                    ...
                    <td rowspan="1" ><?= $alldata[$i+3]['par023']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+3]['par024']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+3]['par025']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+3]['par026']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+3]['par027']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+3]['par028']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+3]['par029']; ?></td>
                    <td rowspan="1" ><?= $alldata[$i+3]['par030']; ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
