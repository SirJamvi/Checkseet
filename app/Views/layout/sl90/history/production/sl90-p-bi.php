<div class="table-responsive mt-3" id="sl90-p-bi">
<?= csrf_field(); ?>
<input type="hidden" id="cnt-table" value="1">
  <table class="table table-bordered table-hover"  id="table1"
    ...
    <thead align="center">
      <tr>
        <th colspan="27" scope="col"><?php echo nl2br("BURN IN")?></th>
      </tr>
    </thead>
    <thead align="center">
      <tr>
    ...
    <tbody>
        <?php for($i = 0; $i < count($alldata); $i=$i+2) { ?>
            <tr>
                ...
                <td rowspan="2" ><?= $alldata[$i]['name'].'('.$alldata[$i]['shift'].')'; ?></td>
                ...
                <td rowspan="2" >
                  <?php
                    if($alldata[$i]['par009']){
                      echo date('d/m/Y', strtotime($alldata[$i]['par009'])); 
                    }
                    else{
                      echo "";
                    }
                ...
                <td rowspan="2" >
                  <?php
                    if($alldata[$i]['name2']){
                      echo  $alldata[$i]['name2'].'('.$alldata[$i]['shift2'].')';
                    }
                    else{
                      echo "";
                    }
                ...
                <td rowspan="2" ><?= $alldata[$i]['par017']; ?></td>
                ...
                <td rowspan="2" ><?= $alldata[$i]['par035']; ?></td>
            </tr>
            <tr>
