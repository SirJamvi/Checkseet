<div class="table-responsive mt-3" id="sl56-s-bi1">
<?= csrf_field(); ?>
...
<table class="table table-bordered table-hover" id="table1">
    <thead align="center">
        <tr>
        <th colspan=<?= 5+$lenData ?> scope="col"><?php echo nl2br("BURN IN MACHINE START UP")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
    ...
    <tbody>
        ...
        <tr>
            <td rowspan="17">2</td>
            <td colspan="2" rowspan="17">@ Memeriksa temperatur oven <br> @ (Checking of oven temperature) <br> Standar toleransi: ± 1 °C <br> (Tolerance Standard: ± 1 °C) <br> Note : <br> Pemeriksaan ini dilakukan pada saat dalam kondisi paling stabil dalam 1 kali Burn In <br> This checking condition do, when it on most stabil condition at 1 time Burn In</td>
            <td rowspan="2">A</td>
