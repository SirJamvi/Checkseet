<div class="table-responsive mt-3" id="sl56-s-ft3">
<?= csrf_field(); ?>
...
<table class="table table-bordered table-hover" id="table1">
    <thead align="center">
        <tr>
            <th colspan=<?= 4+$lenData ?> scope="col"><?php echo nl2br("FINAL TEST START UP (LD1360AHP Type)")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
    ...
    <tbody>
        ...
        <tr>
            <td >7</td>
            <td >* Check & Wear safety goggles <br> * (Memeriksa & memakai kacamatan pengaman)</td>
