<div class="table-responsive mt-3" id="sl56-s-mk">
<?= csrf_field(); ?>
...
<table class="table table-bordered table-hover" id="table1">
    <thead align="center">
      <tr>
        <th colspan="10" scope="col"><?php echo nl2br("MARKING")?></th>
      </tr>
    </thead>
    <thead align="center">
      <tr>
        ...
        <th rowspan="2" scope="col" >Checked</th>
    ...
    <tbody>
        <?php for($i = 0; $i < count($alldata); $i=$i+2) { ?>
            <tr>
                ...
                <?php
                  if((string)$alldata[$i]['name']){
                      echo '<td>'. (string)$alldata[$i]['name'] . '</td>';
                  } 
                  else{
                      echo '<td>  </td>';
                  }
