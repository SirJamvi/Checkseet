<div class="table-responsive mt-3" id="sl56-s-ht2">
<?= csrf_field(); ?>
...
<table class="table table-bordered table-hover" id="table1">
    <thead align="center">
        <tr>
            <th colspan=<?= 6+$lenData ?> scope="col"><?php echo nl2br("HOT TEST MACHINE START UP (LD1220TE Type)\nRED GHZ001A4 (GH0632BA2GL)")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <?php for($i = 0; $i < $lenData; $i=$i+1) { ?>
                <td rowspan="2"><?= (string)$alldata[$i]['par028']; ?></td>
            <?php } ?>
        </tr>
