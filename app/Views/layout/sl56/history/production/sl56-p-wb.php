<div class="table-responsive w-auto mt-3" id="sl56-p-wb">
<input type="hidden" id="cnt-table" value="1">
<?= csrf_field(); ?>
    <table class="table table-bordered table-hover" id="table1">
        <thead align="center">
        <tr>
            <th colspan="36" scope="col"><?php echo nl2br("WIRE BONDING")?></th>
        </tr>
        </thead>
        <thead align="center">
            <tr>
                ...
                <th colspan="3" rowspan="2" scope="col" >Foregoing Inspection (40pcs/lot)</th>
                <th colspan="16" scope="col" >Lakukan wire pull test 4pcs/shift*</th>
            </tr>

            <tr>
                <th scope="col" colspan="8">Sample 1</th>
                <th scope="col" colspan="8">Sample 2</th>
            </tr>
            ...
            <tr>
                ...
                <th scope="col" colspan="2">MS 1</th>
                <th scope="col" colspan="2">MS 2</th>
        ...
        <tbody>
            ...
            <td rowspan="1" ><?= (string)$c['par006']; ?></td>
            <td rowspan="1" ><?= (string)$c['par020']; ?></td>
            <td rowspan="1" ><?= (string)$c['par007']; ?></td>
