...
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
          ...
          <table class="table table-striped-columns">
            <thead align="center">
              <tr>
                <th class="input-form" colspan="8" scope="col">Die Bonding Position*</th>
              ...
              <tr>
                ...
                <tr>
                    <th class="input-form" scope="col">Point 1 <br> (Θc)</th>
                    <th class="input-form" scope="col">Point 2 <br> (Xc)</th>
                    <th class="input-form" scope="col">Point 3 <br> (Zo)</th>
                    <th class="input-form" scope="col">Point 4 <br> (X) </th>
                    <th class="input-form" scope="col">Point 5 <br> (Y)</th>
                    <th class="input-form" scope="col">Point 6 <br> (Z)</th>
                    <th class="input-form" scope="col">Point 7 <br> (Θ)</th>
                </tr>
            </thead>
