<div class="table-responsive" id="slbi">
<?= csrf_field(); ?>
...
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
  <table class="table table-striped-columns" 
    ...
    <tbody>
        ...
        <td rowspan="2" >
          <input type="number" step="1" class="form-control" id="par013" name="par013" onkeyup=quantitySettingSLBI() onchange=quantitySettingSLBI() <?php if(isset($alldata)){echo 'value='.$alldata[0]['par013']." readonly";} ?>>
        </td>
          <td rowspan="2" >
          <input type="number" step="1" class="form-control" id="par014" name="par014" onkeyup=quantitySettingSLBI() onchange=quantitySettingSLBI() <?php if(isset($alldata)){echo 'value='.$alldata[0]['par014'];} ?>>
        </td>
        <td rowspan="2" >
