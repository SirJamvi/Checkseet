<div class="table-responsive" id="sl33-s-ft">
<?= csrf_field(); ?>
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
    ...
    <thead align="center">
        <tr>
        <th colspan="19" scope="col"><?php echo nl2br("FINAL TEST MACHINE START UP CHECK SHEET")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
            ...
            <th colspan="2" >Hasil Start Up</th>
        </tr>
    </thead>
