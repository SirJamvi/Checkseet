<div class="table-responsive" id="sl33-p-ft1">
<?= csrf_field(); ?>
...
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
      <table class="table table-striped-columns" 
        ...
        <thead align="center">
          <tr>
            <th colspan="19" scope="col"><?php echo nl2br("FINAL TEST (Model GH06510F4A & GH06510F4AK)")?></th>
          </tr>
        </thead>
        <thead align="center">
          <tr>
          ...
          <tr>            
                ...
                <th class="input-form" >LDir/ LDir.Err <br> (00)</th>
                <th class="input-form" >lop.Err (01) <br> AGL ≥ 5%</th>
                <th class="input-form" >lop (02) <br> AGL ≥ 5%</th>
                <th class="input-form" >lth <br> (03)</th>
                <th class="input-form" >Kink <br> (04)</th>
                <th class="input-form" >Vop <br> (05)</th>
                <th class="input-form" >Open <br> (06)</th>
                <th class="input-form" >lmop1 <br> (07)</th>
                <th class="input-form" >ldark1/PDlr. <br> (08)</th>
            ...
            <tr>         
                <th class="input-form" scope="col" rowspan="2">GO</th>
                <th class="input-form" scope="col" rowspan="2">NG</th>
                <th class="input-form" scope="col">Phh (0C) <br> AGL ≥ 5%</th>
                <th class="input-form" scope="col">Phv (0D) <br> AGL ≥ 30%</th>
                <th class="input-form" scope="col">Ripple (0E) <br> AGL ≥ 30%</th>
                <th class="input-form" scope="col">LDs.Err <br> (0F)</th>
                <th class="input-form" scope="col">Axis_diff <br> (10)</th>
                <th class="input-form" scope="col">Eta <br> (11)</th>
                <th class="input-form" scope="col">lfPD <br> (12)</th>
                ...
                <th class="input-form" scope="col">Rdl<br> (17)</th>
            </tr>
            <tr>  
                ...
                <th class="input-form" scope="col">Kink3 (1D) <br> AGL ≥ 4%</th>
                <th class="input-form" scope="col">mKink/lm.Err/WL.Err <br> (1E)</th>
