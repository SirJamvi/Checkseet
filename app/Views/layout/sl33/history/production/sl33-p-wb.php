<div class="table-responsive mt-3" id="sl33-p-wb">
<?= csrf_field(); ?>
    ...
    <table class="table table-bordered table-hover" id="table1">
        ...
        <thead align="center">
            <tr>
                ...
                <th rowspan="3" >Gold Wire Lot No.</th>
                <th rowspan="3" >Assy Lot No.</th>
                <th colspan="4" scope="col" >Quantity</th>
                <th colspan="2" scope="col" >Time</th>
                <th colspan="4" scope="col" >Foregoing Inspection (40pcs/lot)</th>
...
<!-- 
    <table class="table table-bordered table-hover" id="slwbhb">
        <thead align="center">
        <tr>
            <th colspan="24" scope="col"><?php echo nl2br("WIRE BONDING PAGE 2")?></th>
        </tr>
        </thead>
        <thead align="center">
            <tr>
            ...
            <tr> 
                <th scope="col" colspan="2">GND</th>
                <th scope="col" colspan="2">SM</th>
