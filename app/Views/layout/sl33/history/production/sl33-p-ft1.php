<div class="table-responsive mt-3" id="sl33-p-ft1">
<?= csrf_field(); ?>
    ...
    <table class="table table-bordered table-hover"  id="table1">
        ...
        <thead align="center">
            ...
            <tr>            
                ...
                <th  >LDir/ LDir.Err <br> (00)</th>
                <th  >lop.Err (01) <br> AGL ≥ 5%</th>
                <th  >lop (02) <br> AGL ≥ 5%</th>
                <th  >lth <br> (03)</th>
                <th  >Kink <br> (04)</th>
                <th  >Vop <br> (05)</th>
                <th  >Open <br> (06)</th>
                <th  >lmop1 <br> (07)</th>
                <th  >ldark1/PDlr. <br> (08)</th>
                <th  >LP<br> (09)</th>
                <th  >Thh <br> (0A)</th>
                <th  >Thv <br> (0B)</th>
            </tr>
            ...
            <tr>         
                ...
                <th scope="col">Phh (0C) <br> AGL ≥ 5%</th>
                <th scope="col">Phv (0D) <br> AGL ≥ 30%</th>
                <th scope="col">Ripple (0E) <br> AGL ≥ 30%</th>
                <th scope="col">LDs.Err <br> (0F)</th>
                <th scope="col">Axis_diff <br> (10)</th>
                <th scope="col">Eta <br> (11)</th>
                <th scope="col">lfPD <br> (12)</th>
                <th scope="col">Vnr1/Vnr2 <br> (13)</th>
                <th scope="col">lf.LD <br> (14)</th>
                <th scope="col">Vim <br> (15)</th>
                <th scope="col">Pulse <br> (16)</th>
                <th scope="col">Rdl<br> (17)</th>
            </tr>
            <tr>  
                ...
                <th scope="col">Kink3 (1D) <br> AGL ≥ 4%</th>
                <th scope="col">mKink/lm.Err/WL.Err <br> (1E)</th>
