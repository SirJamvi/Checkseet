<div class="table-responsive mt-3" id="sl38-p-ldsm">
<?= csrf_field(); ?>
<input type="hidden" id="cnt-table" value="1">
    <table class="table table-bordered table-hover" id="table1">
    <thead align="center">
        <tr>
        <th colspan="24" scope="col"><?php echo nl2br("LDSM MACHINE\n(Single Laser 3.8)")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
        ...
        <tr>
            ...
            <th scope="col">Point 5 <br> (Z)</th>
            <th scope="col">Point 6 <br> (Θ)</th>
        </tr>
    </thead>
