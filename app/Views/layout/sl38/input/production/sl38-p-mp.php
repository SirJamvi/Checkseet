...
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
  <table class="table table-striped-columns" >
    <thead align="center">
        <tr>
            <th colspan="5" scope="col"><?php echo nl2br("PRODUCTION PROCESS CONTROL SHEET METAL PASTE HARDENING")?></th>
        </tr>
    </thead>
    <thead align="center">
        <tr>
            <th class="input-form" class="input-form" colspan="2" scope="col" >Quantity</th>
            <th class="input-form" class="input-form" colspan="3" scope="col" >Temperature</th>
        </tr>
        <tr>
            <th class="input-form" class="input-form" >Input</th>
            <th class="input-form" class="input-form" >Output</th>
            <th class="input-form" class="input-form" >Setting</th>
            <th class="input-form" class="input-form" >At Input</th>
            <th class="input-form" class="input-form" >At take Out</th>
        </tr>
    </thead>
    <tbody>
        <td rowspan="1" >
