<div class="table-responsive" id="sl38-p-ldsmqc">
<?= csrf_field(); ?>
...
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
          <table class="table table-striped-columns" 
            ...
            <thead align="center">
              <tr>
                <th colspan="19" scope="col"><?php echo nl2br("INSPECTION LDSM CONTROL")?></th>
              </tr>
            </thead>
            <thead align="center">
              <tr>
              ...
              <tr>
                ...
                <th class="input-form" scope="col">LD Chipping</th>
