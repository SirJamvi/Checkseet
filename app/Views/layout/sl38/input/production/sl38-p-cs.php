<div class="table-responsive" id="sl38-p=cs">
<?= csrf_field(); ?>
  ...
  <table class="table table-striped-columns" <?php $selected_device = filter_input(INPUT_POST, 'device',	FILTER_SANITIZE_STRING, FILTER_REQUIRE_ARRAY
    ...
    <thead align="center">
      <tr>
        ...
        <th class="input-form" colspan="2"  rowspan="4">Dimension Measurement <br> (3.775 - 3.800 mm)</th>
    ...
    <tbody>
      <tr>
        ...
        <td rowspan="2" >
          <input type="number" step="0.00000001" class="form-control" id="par002" name="par002" <?php if(isset($alldata)){echo 'value='.$alldata[0]['par002'];} ?>>
        </td>
        <td rowspan="2" >
        ...
        </td<td  class="input-form" rowspan="2"  >
