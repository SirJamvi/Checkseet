...
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
      <table class="table table-striped-columns" 
        ...
        <thead align="center">
          <tr>
            <th class="input-form" colspan="4" scope="col" style="width:25%;">Quantity</th>
          ...
          <tr>            
            ...
            <th class="input-form">lf.PD/RdPo ldrak1/ lmop/m.Kink <br> (00)</th>
            <th class="input-form">lf.LD <br> (01)</th>
            <th class="input-form">LD.lr <br> (02)</th>
            ...
            <th class="input-form"class="input-form">L.Kink2 <br> (07)</th>
            <th class="input-form">Pmax <br> (08)</th>
            <th class="input-form">lmax <br> (09)</th>
            <th class="input-form">Pol <br> (0A)</th>
            <th class="input-form">PhPl <br> (0B)</th>
          </tr>

          <tr>
            <th class="input-form">Thv <br> (0C)</th>
            <th class="input-form">Thh <br> (0D)</th>
            <th class="input-form">Phv <br> (0E)</th>
            <th class="input-form">Phh <br> (0F)</th>
            <th class="input-form">Rpv <br> (10)</th>
            <th class="input-form">Rph <br> (11)</th>
            <th class="input-form">Lp <br> (12)</th>
            <th class="input-form">LD Short <br> (13)</th>
            <th class="input-form">LD Open <br> (14)</th>
            <th class="input-form">lop.Err <br> (15)</th>
            <th class="input-form">Kink.Err <br> (16)</th>
            <th class="input-form">Pol.Err <br> (17)</th>
          </tr>

        <tr>
            <th class="input-form">FFV.Err <br> (18)</th>
            <th class="input-form">FFh.Err <br> (19)</th>
            <th class="input-form">SP.Err <br> (1A)</th>
            <th class="input-form">LDlr.Err <br> (1B)</th>
            <th class="input-form">lm.Err/PDlr.Err <br> (1C)</th>
            <th class="input-form">L.Kink3 <br> (1D)</th>
            <th class="input-form">L.Kink4 <br> (1E)</th>
            <th class="input-form">Others</th>
            <th class="input-form">RANK 2</th>
            <th class="input-form">RANK 3</th>
            <th class="input-form">RANK 4</th>
