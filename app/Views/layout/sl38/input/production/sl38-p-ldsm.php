...
<input type="hidden" id="number-edit" name="number-edit" value=<?php if(isset($alldata)){echo $number;} ?>>
          <table class="table table-striped-columns" <?php $selected_device = filter_input(INPUT_POST, 'device',	FILTER_SANITIZE_STRING, FILTER_REQUIRE_ARRAY
            ...
            <tbody>
              <tr>
                <td rowspan="2" >
                  <input type="number"  oninput="" step="1" class="form-control" id="par013" name="par013" onkeyup=quantityChange7() onchange=quantityChange7() <?php if(isset($alldata)){echo 'value='.$alldata[0]['par013'];} ?>>
                </td>
                <td rowspan="2" >
                  <input type="number"  oninput="" step="1" class="form-control" id="par014" name="par014" onkeyup=quantityChange7() onchange=quantityChange7() <?php if(isset($alldata)){echo 'value='.$alldata[0]['par014'];} ?>>
                </td>
                <td rowspan="1" >
            ...
            <thead align="center">
              ...
              <tr>
                ...
                <tr>
                    ...
                    <th class="input-form" scope="col">Point 5 <br> (Z)</th>
                    <th class="input-form" scope="col">Point 6 <br> (Θ)</th>
                </tr>
            </thead>
